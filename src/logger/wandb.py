...
class WandBWriter:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            logger.info("W&B running in OFFLINE mode. Data will be saved locally.")
            logger.info("To sync later, run: wandb sync ./wandb_offline/")
    ...
    def add_text(self, text_name, text):
        ...
        """
        self.wandb.log({text_name: self.wandb.Html(text)}, step=self.step)
